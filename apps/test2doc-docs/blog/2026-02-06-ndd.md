...
tags: [testing]
---
So, I've been working on Test2Doc for almost half a year now.

I've written a few example apps and even a [tutorial](/docs/tutorial-1) walking through how to test-drive a non-trivial app with Playwright and RedwoodSDK.

I'd like to hope the _why_ is obvious. But just as a recap, if it is not obvious (or maybe this is your first time reading about Test2Doc):
...
Enters my buzzword acronym to try and solve this problem:
