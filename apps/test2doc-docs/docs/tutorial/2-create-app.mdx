...
Create a `.prettierrc` file in the root of your project with the following contents:
...
And a `.prettierignore` file, also in the root of your project:
...
Now, create an `eslint.config.js` file in the root of your project with the following contents:
...
To find the guide to install the reporter, it can be found [here](../../../docs/getting-started/install#install-the-reporter), or you can follow the instructions below:
...
- Set up Durable Objects SQLite as your database and create your first database schema
