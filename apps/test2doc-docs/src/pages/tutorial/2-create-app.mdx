...
<Tabs groupId="package-managers">
  <TabItem value="npm" label="npm" default>
```sh
npm install --save-dev eslint @eslint/js @typescript-eslint/eslint-plugin @typescript-eslint/parser eslint-plugin-react eslint-plugin-react-hooks eslint-plugin-playwright eslint-config-prettier typescript-eslint
```
  </TabItem>
  <TabItem value="yarn" label="yarn">
```sh
yarn add --dev eslint @eslint/js @typescript-eslint/eslint-plugin @typescript-eslint/parser eslint-plugin-react eslint-plugin-react-hooks eslint-plugin-playwright eslint-config-prettier typescript-eslint
```
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
```sh
pnpm add --save-dev eslint @eslint/js @typescript-eslint/eslint-plugin @typescript-eslint/parser eslint-plugin-react eslint-plugin-react-hooks eslint-plugin-playwright eslint-config-prettier typescript-eslint
```
  </TabItem>
</Tabs>
